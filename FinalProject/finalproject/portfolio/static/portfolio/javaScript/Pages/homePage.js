...
export function homePage(
    ...
    if (main.dataset.language === "en") {
        container.insertAdjacentHTML(
            "afterbegin",
            `${authorIntroduction("en")} ${aboutMe("en")}`
        );
    } else {
        container.insertAdjacentHTML(
            "afterbegin",
                ...
                const activeItem =
                    container.offsetWidth > 850
                        ? document.querySelector(
                              ".navA.active.navBar-bigScreen"
                          )
                        : document.querySelector(
                              ".navA.active.navBar-smallScreen"
                          );
                activeItem.classList.remove("active");
                container.offsetWidth > 850
                    ? document
                          .querySelector(
                              ".navBar-bigScreen[data-page='projects']"
                          )
                          .classList.add("active")
                    : document
                          .querySelector(
                              ".navBar-smallScreen[data-page='projects']"
                          )
                          .classList.add("active");
    ...
    const containerHeigt = document.querySelector(
        ".authorIntroduction"
    ).offsetHeight;
